...
public class CoordinatesTest {
    ...
    /**
     * Tests that the Coordinates class constructor correctly initializes the x and y fields.
     */
    @Test
    ...
    /**
     * Tests that the copy() method correctly creates a new instance of Coordinates with updated values.
     */
    @Test
    ...
    /**
     * Tests that the Coordinates class constructor throws an IllegalArgumentException when given invalid input values.
     */
    @Test
    ...
    /**
     * Tests that the equals() and hashCode() methods correctly compare the values of two Coordinates objects.
     */
    @Test
